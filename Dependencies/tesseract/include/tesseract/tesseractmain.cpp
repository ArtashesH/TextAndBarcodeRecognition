...
int main(int argc, char** argv) {
	...
	//
	//
	//  //**************************************************************___________AVELACNELU TEX___________**************************************************************//
	//
	//
	//
	//
	...
	std::string img_path;
	if (!argv) {
		img_path = "E:\\Projects\\tesseractTest\\x64\\Release\\robotPart.png";
	}
	else {
		img_path = argv[1];
	}
	...
	//testImg = rotateImageWithAngle(-30, testImg);
	...
	//system("cls");
	//std::cout << "OCR output:" << out << std::endl;
	//cv::imshow("testImg", m_image);
	//cv::waitKey(0);
	//system("cls");
	std::cout << "OCR output:" << out << std::endl;
}
